...
export class JobTap {
	...
	#disposed = false;
	/** @type {undefined | ((jobId: string) => void)} optional track observer (diagnostics) */
	#onTrack;

	/**
	 * @param {{ onTrack?: (jobId: string) => void }} [options] - onTrack fires
	 *   after a job is successfully tracked (never throws into the caller).
	 */
	constructor(options = {}) {
